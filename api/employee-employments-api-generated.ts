...
export const EmployeeEmploymentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteRehire: async (employeeId: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'employeeId' is not null or undefined
            assertParamExists('deleteRehire', 'employeeId', employeeId)
            const localVarPath = `/v1/employees/{employee_id}/rehire`
                .replace(`{${"employee_id"}}`, encodeURIComponent(String(employeeId !== undefined ? employeeId : `-employee_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        getRehireInfo: async (employeeId: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'employeeId' is not null or undefined
            assertParamExists('getRehireInfo', 'employeeId', employeeId)
            const localVarPath = `/v1/employees/{employee_id}/rehire`
                .replace(`{${"employee_id"}}`, encodeURIComponent(String(employeeId !== undefined ? employeeId : `-employee_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        listTerminationsForEmployee: async (employeeId: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'employeeId' is not null or undefined
            assertParamExists('listTerminationsForEmployee', 'employeeId', employeeId)
            const localVarPath = `/v1/employees/{employee_id}/terminations`
                .replace(`{${"employee_id"}}`, encodeURIComponent(String(employeeId !== undefined ? employeeId : `-employee_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const EmployeeEmploymentsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Delete an employee rehire. An employee rehire cannot be deleted if it\'s active (past effective date).  scope: `employments:write`
         * @summary Delete an employee rehire
         * @param {EmployeeEmploymentsApiDeleteRehireRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async deleteRehire(requestParameters: EmployeeEmploymentsApiDeleteRehireRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteRehire(requestParameters.employeeId, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Delete an employee termination.  scope: `employments:write`
         ...
         * Retrieve an employee\'s rehire, which contains information on when the employee returns to work.  scope: `employments:read`
         * @summary Get an employee rehire
         * @param {EmployeeEmploymentsApiGetRehireInfoRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getRehireInfo(requestParameters: EmployeeEmploymentsApiGetRehireInfoRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Rehire>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRehireInfo(requestParameters.employeeId, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Terminations are created whenever an employee is scheduled to leave the company. The only things required are an effective date (their last day of work) and whether they should receive their wages in a one-off termination payroll or with the rest of the company.  Note that some states require employees to receive their final wages within 24 hours (unless they consent otherwise,) in which case running a one-off payroll may be the only option.  scope: `employments:read`
         * @summary Get terminations for an employee
         * @param {EmployeeEmploymentsApiListTerminationsForEmployeeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listTerminationsForEmployee(requestParameters: EmployeeEmploymentsApiListTerminationsForEmployeeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Termination>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listTerminationsForEmployee(requestParameters.employeeId, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update an employee\'s rehire.  scope: `employments:write`
...
export const EmployeeEmploymentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteRehire(requestParameters: EmployeeEmploymentsApiDeleteRehireRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteRehire(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete an employee termination.  scope: `employments:write`
         * @summary Delete an employee termination
         ...
         * @throws {RequiredError}
         */
        getRehireInfo(requestParameters: EmployeeEmploymentsApiGetRehireInfoRequest, options?: AxiosRequestConfig): AxiosPromise<Rehire> {
            return localVarFp.getRehireInfo(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Terminations are created whenever an employee is scheduled to leave the company. The only things required are an effective date (their last day of work) and whether they should receive their wages in a one-off termination payroll or with the rest of the company.  Note that some states require employees to receive their final wages within 24 hours (unless they consent otherwise,) in which case running a one-off payroll may be the only option.  scope: `employments:read`
         * @summary Get terminations for an employee
         ...
         * @throws {RequiredError}
         */
        listTerminationsForEmployee(requestParameters: EmployeeEmploymentsApiListTerminationsForEmployeeRequest, options?: AxiosRequestConfig): AxiosPromise<Array<Termination>> {
            return localVarFp.listTerminationsForEmployee(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update an employee\'s rehire.  scope: `employments:write`
         * @summary Update an employee rehire
...
/**
 * Request parameters for deleteRehire operation in EmployeeEmploymentsApi.
 * @export
 * @interface EmployeeEmploymentsApiDeleteRehireRequest
 */
export type EmployeeEmploymentsApiDeleteRehireRequest = {
    
    /**
    * The UUID of the employee
    * @type {string}
    * @memberof EmployeeEmploymentsApiDeleteRehire
    */
    readonly employeeId: string
...
/**
 * Request parameters for getRehireInfo operation in EmployeeEmploymentsApi.
 * @export
 * @interface EmployeeEmploymentsApiGetRehireInfoRequest
 */
export type EmployeeEmploymentsApiGetRehireInfoRequest = {
    
    /**
    * The UUID of the employee
    * @type {string}
    * @memberof EmployeeEmploymentsApiGetRehireInfo
    */
    readonly employeeId: string
...
/**
 * Request parameters for listTerminationsForEmployee operation in EmployeeEmploymentsApi.
 * @export
 * @interface EmployeeEmploymentsApiListTerminationsForEmployeeRequest
 */
export type EmployeeEmploymentsApiListTerminationsForEmployeeRequest = {
    
    /**
    * The UUID of the employee
    * @type {string}
    * @memberof EmployeeEmploymentsApiListTerminationsForEmployee
    */
    readonly employeeId: string
...
export class EmployeeEmploymentsApiGenerated extends BaseAPI {
     ...
     * @memberof EmployeeEmploymentsApiGenerated
     */
    public deleteRehire(requestParameters: EmployeeEmploymentsApiDeleteRehireRequest, options?: AxiosRequestConfig) {
        return EmployeeEmploymentsApiFp(this.configuration).deleteRehire(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EmployeeEmploymentsApiGenerated
     */
    public getRehireInfo(requestParameters: EmployeeEmploymentsApiGetRehireInfoRequest, options?: AxiosRequestConfig) {
        return EmployeeEmploymentsApiFp(this.configuration).getRehireInfo(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EmployeeEmploymentsApiGenerated
     */
    public listTerminationsForEmployee(requestParameters: EmployeeEmploymentsApiListTerminationsForEmployeeRequest, options?: AxiosRequestConfig) {
        return EmployeeEmploymentsApiFp(this.configuration).listTerminationsForEmployee(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
