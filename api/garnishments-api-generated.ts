...
// @ts-ignore
import { GarnishmentsUpdateRequest } from '../models';
// @ts-ignore
...
export const GarnishmentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        get: async (garnishmentId: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'garnishmentId' is not null or undefined
            assertParamExists('get', 'garnishmentId', garnishmentId)
         ...
         * @param {string} garnishmentId The UUID of the garnishment
         * @param {'2024-03-01'} [xGustoApiVersion] Determines the date-based API version associated with your API call. If none is provided, your application\&#39;s [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
         * @param {GarnishmentsUpdateRequest} [garnishmentsUpdateRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        update: async (garnishmentId: string, xGustoApiVersion?: '2024-03-01', garnishmentsUpdateRequest?: GarnishmentsUpdateRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'garnishmentId' is not null or undefined
            assertParamExists('update', 'garnishmentId', garnishmentId)
            const localVarPath = `/v1/garnishments/{garnishment_id}`
                .replace(`{${"garnishment_id"}}`, encodeURIComponent(String(garnishmentId !== undefined ? garnishmentId : `-garnishment_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: garnishmentsUpdateRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(garnishmentsUpdateRequest, localVarRequestOptions, configuration)
...
export const GarnishmentsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Garnishments, or employee deductions, are fixed amounts or percentages deducted from an employee’s pay. They can be deducted a specific number of times or on a recurring basis. Garnishments can also have maximum deductions on a yearly or per-pay-period bases. Common uses for garnishments are court-ordered payments for child support or back taxes. Some companies provide loans to their employees that are repaid via garnishments.  scope: `garnishments:read`
         * @summary Get a garnishment
         * @param {GarnishmentsApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: GarnishmentsApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Garnishment>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.get(requestParameters.garnishmentId, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Garnishments, or employee deductions, are fixed amounts or percentages deducted from an employee’s pay. They can be deducted a specific number of times or on a recurring basis. Garnishments can also have maximum deductions on a yearly or per-pay-period bases. Common uses for garnishments are court-ordered payments for child support or back taxes. Some companies provide loans to their employees that are repaid via garnishments.  scope: `garnishments:read`
         ...
         * Garnishments, or employee deductions, are fixed amounts or percentages deducted from an employee’s pay. They can be deducted a specific number of times or on a recurring basis. Garnishments can also have maximum deductions on a yearly or per-pay-period bases. Common uses for garnishments are court-ordered payments for child support or back taxes. Some companies provide loans to their employees that are repaid via garnishments.  scope: `garnishments:write`
         * @summary Update a garnishment
         * @param {GarnishmentsApiUpdateRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async update(requestParameters: GarnishmentsApiUpdateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Garnishment>> {
            const garnishmentsUpdateRequest: GarnishmentsUpdateRequest = {
                description: requestParameters.description,
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.update(requestParameters.garnishmentId, requestParameters.xGustoApiVersion, garnishmentsUpdateRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const GarnishmentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: GarnishmentsApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<Garnishment> {
         ...
         * @throws {RequiredError}
         */
        update(requestParameters: GarnishmentsApiUpdateRequest, options?: AxiosRequestConfig): AxiosPromise<Garnishment> {
...
/**
 * Request parameters for get operation in GarnishmentsApi.
 * @export
 * @interface GarnishmentsApiGetRequest
 */
export type GarnishmentsApiGetRequest = {
    
    /**
    * The UUID of the garnishment
    * @type {string}
    * @memberof GarnishmentsApiGet
    */
...
/**
 * Request parameters for update operation in GarnishmentsApi.
 * @export
 * @interface GarnishmentsApiUpdateRequest
 */
export type GarnishmentsApiUpdateRequest = {
    
    /**
    * The UUID of the garnishment
    * @type {string}
    * @memberof GarnishmentsApiUpdate
    */
    readonly garnishmentId: string
...
export class GarnishmentsApiGenerated extends BaseAPI {
     ...
     * @memberof GarnishmentsApiGenerated
     */
    public get(requestParameters: GarnishmentsApiGetRequest, options?: AxiosRequestConfig) {
        return GarnishmentsApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof GarnishmentsApiGenerated
     */
    public update(requestParameters: GarnishmentsApiUpdateRequest, options?: AxiosRequestConfig) {
        return GarnishmentsApiFp(this.configuration).update(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
