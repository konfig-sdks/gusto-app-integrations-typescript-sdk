...
// @ts-ignore
import { DepartmentsRemoveEmployeesRequest } from '../models';
// @ts-ignore
...
export const DepartmentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getByUuid: async (departmentUuid: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'departmentUuid' is not null or undefined
            assertParamExists('getByUuid', 'departmentUuid', departmentUuid)
            const localVarPath = `/v1/departments/{department_uuid}`
                .replace(`{${"department_uuid"}}`, encodeURIComponent(String(departmentUuid !== undefined ? departmentUuid : `-department_uuid-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @param {string} departmentUuid The UUID of the department
         * @param {'2024-03-01'} [xGustoApiVersion] Determines the date-based API version associated with your API call. If none is provided, your application\&#39;s [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
         * @param {DepartmentsRemoveEmployeesRequest} [departmentsRemoveEmployeesRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        removeEmployees: async (departmentUuid: string, xGustoApiVersion?: '2024-03-01', departmentsRemoveEmployeesRequest?: DepartmentsRemoveEmployeesRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'departmentUuid' is not null or undefined
            assertParamExists('removeEmployees', 'departmentUuid', departmentUuid)
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: departmentsRemoveEmployeesRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(departmentsRemoveEmployeesRequest, localVarRequestOptions, configuration)
...
export const DepartmentsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Get a department given the UUID  scope: `departments:read` 
         * @summary Get a department
         * @param {DepartmentsApiGetByUuidRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getByUuid(requestParameters: DepartmentsApiGetByUuidRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Department>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getByUuid(requestParameters.departmentUuid, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get all of the departments for a given company with the employees and contractors assigned to that department.  scope: `departments:read`
         * @summary Get all departments of a company
         * @param {DepartmentsApiListForCompanyRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listForCompany(requestParameters: DepartmentsApiListForCompanyRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Department>>> {
         ...
         * Remove employees and contractors from a department  scope: `departments:write` 
         * @summary Remove people from a department
         * @param {DepartmentsApiRemoveEmployeesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async removeEmployees(requestParameters: DepartmentsApiRemoveEmployeesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Department>> {
            const departmentsRemoveEmployeesRequest: DepartmentsRemoveEmployeesRequest = {
                version: requestParameters.version,
                employees: requestParameters.employees,
                contractors: requestParameters.contractors
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.removeEmployees(requestParameters.departmentUuid, requestParameters.xGustoApiVersion, departmentsRemoveEmployeesRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a department  scope: `departments:write`
...
export const DepartmentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getByUuid(requestParameters: DepartmentsApiGetByUuidRequest, options?: AxiosRequestConfig): AxiosPromise<Department> {
            return localVarFp.getByUuid(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get all of the departments for a given company with the employees and contractors assigned to that department.  scope: `departments:read`
         * @summary Get all departments of a company
         ...
         * @throws {RequiredError}
         */
        listForCompany(requestParameters: DepartmentsApiListForCompanyRequest, options?: AxiosRequestConfig): AxiosPromise<Array<Department>> {
         ...
         * @throws {RequiredError}
         */
        removeEmployees(requestParameters: DepartmentsApiRemoveEmployeesRequest, options?: AxiosRequestConfig): AxiosPromise<Department> {
...
/**
 * Request parameters for getByUuid operation in DepartmentsApi.
 * @export
 * @interface DepartmentsApiGetByUuidRequest
 */
export type DepartmentsApiGetByUuidRequest = {
    
    /**
    * The UUID of the department
    * @type {string}
    * @memberof DepartmentsApiGetByUuid
    */
    readonly departmentUuid: string
...
/**
 * Request parameters for listForCompany operation in DepartmentsApi.
 * @export
 * @interface DepartmentsApiListForCompanyRequest
 */
export type DepartmentsApiListForCompanyRequest = {
    
    /**
    * The UUID of the company
    * @type {string}
    * @memberof DepartmentsApiListForCompany
    */
    readonly companyUuid: string
...
/**
 * Request parameters for removeEmployees operation in DepartmentsApi.
 * @export
 * @interface DepartmentsApiRemoveEmployeesRequest
 */
export type DepartmentsApiRemoveEmployeesRequest = {
    
    /**
    * The UUID of the department
    * @type {string}
    * @memberof DepartmentsApiRemoveEmployees
    */
    readonly departmentUuid: string
...
export class DepartmentsApiGenerated extends BaseAPI {
     ...
     * @memberof DepartmentsApiGenerated
     */
    public getByUuid(requestParameters: DepartmentsApiGetByUuidRequest, options?: AxiosRequestConfig) {
        return DepartmentsApiFp(this.configuration).getByUuid(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DepartmentsApiGenerated
     */
    public listForCompany(requestParameters: DepartmentsApiListForCompanyRequest, options?: AxiosRequestConfig) {
        return DepartmentsApiFp(this.configuration).listForCompany(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DepartmentsApiGenerated
     */
    public removeEmployees(requestParameters: DepartmentsApiRemoveEmployeesRequest, options?: AxiosRequestConfig) {
        return DepartmentsApiFp(this.configuration).removeEmployees(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
