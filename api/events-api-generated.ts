...
export const EventsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAll: async (startingAfterUuid?: string, resourceUuid?: string, limit?: string, eventType?: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const EventsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Fetch all events, going back up to 30 days, that your partner application has the required scopes for. Note that a partner does NOT have to have verified webhook subscriptions in order to utilize this endpoint.  > 📘 Token Authentication > > This endpoint uses the [organization level api token and the Token scheme with HTTP Authorization header](https://docs.gusto.com/embedded-payroll/docs/authentication#api-token-authentication).  scope: `events:read`
         * @summary Get all events
         * @param {EventsApiGetAllRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getAll(requestParameters: EventsApiGetAllRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Event>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAll(requestParameters.startingAfterUuid, requestParameters.resourceUuid, requestParameters.limit, requestParameters.eventType, requestParameters.xGustoApiVersion, options);
...
export const EventsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAll(requestParameters: EventsApiGetAllRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Array<Event>> {
...
/**
 * Request parameters for getAll operation in EventsApi.
 * @export
 * @interface EventsApiGetAllRequest
 */
export type EventsApiGetAllRequest = {
    
    /**
    * A cursor for pagination. Returns all events occuring after the specified UUID (exclusive)
    * @type {string}
    * @memberof EventsApiGetAll
    */
...
export class EventsApiGenerated extends BaseAPI {
     ...
     */
    public getAll(requestParameters: EventsApiGetAllRequest = {}, options?: AxiosRequestConfig) {
        return EventsApiFp(this.configuration).getAll(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
