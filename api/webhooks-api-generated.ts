...
// @ts-ignore
import { WebhooksUpdateSubscriptionByUuidRequest } from '../models';
// @ts-ignore
...
export const WebhooksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getSubscriptionByUuid: async (webhookSubscriptionUuid: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'webhookSubscriptionUuid' is not null or undefined
            assertParamExists('getSubscriptionByUuid', 'webhookSubscriptionUuid', webhookSubscriptionUuid)
            const localVarPath = `/v1/webhook_subscriptions/{webhook_subscription_uuid}`
                .replace(`{${"webhook_subscription_uuid"}}`, encodeURIComponent(String(webhookSubscriptionUuid !== undefined ? webhookSubscriptionUuid : `-webhook_subscription_uuid-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @param {string} webhookSubscriptionUuid The webhook subscription UUID.
         * @param {'2024-03-01'} [xGustoApiVersion] Determines the date-based API version associated with your API call. If none is provided, your application\&#39;s [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
         * @param {WebhooksUpdateSubscriptionByUuidRequest} [webhooksUpdateSubscriptionByUuidRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateSubscriptionByUuid: async (webhookSubscriptionUuid: string, xGustoApiVersion?: '2024-03-01', webhooksUpdateSubscriptionByUuidRequest?: WebhooksUpdateSubscriptionByUuidRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'webhookSubscriptionUuid' is not null or undefined
            assertParamExists('updateSubscriptionByUuid', 'webhookSubscriptionUuid', webhookSubscriptionUuid)
            const localVarPath = `/v1/webhook_subscriptions/{webhook_subscription_uuid}`
                .replace(`{${"webhook_subscription_uuid"}}`, encodeURIComponent(String(webhookSubscriptionUuid !== undefined ? webhookSubscriptionUuid : `-webhook_subscription_uuid-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: webhooksUpdateSubscriptionByUuidRequest,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(webhooksUpdateSubscriptionByUuidRequest, localVarRequestOptions, configuration)
...
export const WebhooksApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Returns the Webhook Subscription associated with the provided UUID.  > 📘 Token Authentication > > This endpoint uses the [organization level api token and the Token scheme with HTTP Authorization header](https://docs.gusto.com/embedded-payroll/docs/authentication#api-token-authentication).  scope: `webhook_subscriptions:read` 
         * @summary Get a webhook subscription
         * @param {WebhooksApiGetSubscriptionByUuidRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getSubscriptionByUuid(requestParameters: WebhooksApiGetSubscriptionByUuidRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhookSubscription>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSubscriptionByUuid(requestParameters.webhookSubscriptionUuid, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns all webhook subscriptions associated with the provided Partner API token.  > 📘 Token Authentication > > This endpoint uses the [organization level api token and the Token scheme with HTTP Authorization header](https://docs.gusto.com/embedded-payroll/docs/authentication#api-token-authentication).  scope: `webhook_subscriptions:read`
         ...
         * Updates the Webhook Subscription associated with the provided UUID.  > 📘 Token Authentication > > This endpoint uses the [organization level api token and the Token scheme with HTTP Authorization header](https://docs.gusto.com/embedded-payroll/docs/authentication#api-token-authentication).  scope: `webhook_subscriptions:write` 
         * @summary Update a webhook subscription
         * @param {WebhooksApiUpdateSubscriptionByUuidRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateSubscriptionByUuid(requestParameters: WebhooksApiUpdateSubscriptionByUuidRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhookSubscription>> {
            const webhooksUpdateSubscriptionByUuidRequest: WebhooksUpdateSubscriptionByUuidRequest = {
                subscription_types: requestParameters.subscription_types
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateSubscriptionByUuid(requestParameters.webhookSubscriptionUuid, requestParameters.xGustoApiVersion, webhooksUpdateSubscriptionByUuidRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * When a webhook subscription is created, a `verification_token` is POSTed to the registered webhook subscription URL. This `verify` endpoint needs to be called with `verification_token` before webhook events can be sent to the registered webhook URL.  Use the /v1/webhook_subscriptions/{webhook_subscription_uuid}/request_verification_token API to resend the `verification_token` to the Subscriber.  > 📘 Token Authentication > > This endpoint uses the [organization level api token and the Token scheme with HTTP Authorization header](https://docs.gusto.com/embedded-payroll/docs/authentication#api-token-authentication).  scope: `webhook_subscriptions:write` 
...
export const WebhooksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getSubscriptionByUuid(requestParameters: WebhooksApiGetSubscriptionByUuidRequest, options?: AxiosRequestConfig): AxiosPromise<WebhookSubscription> {
            return localVarFp.getSubscriptionByUuid(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns all webhook subscriptions associated with the provided Partner API token.  > 📘 Token Authentication > > This endpoint uses the [organization level api token and the Token scheme with HTTP Authorization header](https://docs.gusto.com/embedded-payroll/docs/authentication#api-token-authentication).  scope: `webhook_subscriptions:read`
         * @summary List webhook subscriptions
         ...
         * @throws {RequiredError}
         */
        updateSubscriptionByUuid(requestParameters: WebhooksApiUpdateSubscriptionByUuidRequest, options?: AxiosRequestConfig): AxiosPromise<WebhookSubscription> {
            return localVarFp.updateSubscriptionByUuid(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * When a webhook subscription is created, a `verification_token` is POSTed to the registered webhook subscription URL. This `verify` endpoint needs to be called with `verification_token` before webhook events can be sent to the registered webhook URL.  Use the /v1/webhook_subscriptions/{webhook_subscription_uuid}/request_verification_token API to resend the `verification_token` to the Subscriber.  > 📘 Token Authentication > > This endpoint uses the [organization level api token and the Token scheme with HTTP Authorization header](https://docs.gusto.com/embedded-payroll/docs/authentication#api-token-authentication).  scope: `webhook_subscriptions:write` 
         * @summary Verify the webhook subscription
...
/**
 * Request parameters for getSubscriptionByUuid operation in WebhooksApi.
 * @export
 * @interface WebhooksApiGetSubscriptionByUuidRequest
 */
export type WebhooksApiGetSubscriptionByUuidRequest = {
    
    /**
    * The webhook subscription UUID.
    * @type {string}
    * @memberof WebhooksApiGetSubscriptionByUuid
    */
    readonly webhookSubscriptionUuid: string
...
/**
 * Request parameters for updateSubscriptionByUuid operation in WebhooksApi.
 * @export
 * @interface WebhooksApiUpdateSubscriptionByUuidRequest
 */
export type WebhooksApiUpdateSubscriptionByUuidRequest = {
    
    /**
    * The webhook subscription UUID.
    * @type {string}
    * @memberof WebhooksApiUpdateSubscriptionByUuid
    */
    readonly webhookSubscriptionUuid: string
...
export class WebhooksApiGenerated extends BaseAPI {
     ...
     * @memberof WebhooksApiGenerated
     */
    public getSubscriptionByUuid(requestParameters: WebhooksApiGetSubscriptionByUuidRequest, options?: AxiosRequestConfig) {
        return WebhooksApiFp(this.configuration).getSubscriptionByUuid(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebhooksApiGenerated
     */
    public updateSubscriptionByUuid(requestParameters: WebhooksApiUpdateSubscriptionByUuidRequest, options?: AxiosRequestConfig) {
        return WebhooksApiFp(this.configuration).updateSubscriptionByUuid(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
