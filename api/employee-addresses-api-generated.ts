...
export const EmployeeAddressesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteEmployeeHomeAddress: async (homeAddressUuid: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'homeAddressUuid' is not null or undefined
            assertParamExists('deleteEmployeeHomeAddress', 'homeAddressUuid', homeAddressUuid)
         ...
         * @throws {RequiredError}
         */
        deleteEmployeeWorkAddress: async (workAddressUuid: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workAddressUuid' is not null or undefined
            assertParamExists('deleteEmployeeWorkAddress', 'workAddressUuid', workAddressUuid)
         ...
         * @throws {RequiredError}
         */
        get: async (workAddressUuid: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workAddressUuid' is not null or undefined
            assertParamExists('get', 'workAddressUuid', workAddressUuid)
            const localVarPath = `/v1/work_addresses/{work_address_uuid}`
                .replace(`{${"work_address_uuid"}}`, encodeURIComponent(String(workAddressUuid !== undefined ? workAddressUuid : `-work_address_uuid-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
         ...
         * @throws {RequiredError}
         */
        getWorkAddresses: async (employeeId: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'employeeId' is not null or undefined
            assertParamExists('getWorkAddresses', 'employeeId', employeeId)
            const localVarPath = `/v1/employees/{employee_id}/work_addresses`
                .replace(`{${"employee_id"}}`, encodeURIComponent(String(employeeId !== undefined ? employeeId : `-employee_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const EmployeeAddressesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Used for deleting an employee\'s home address.  Cannot delete the employee\'s active home address.  scope: `employees:write`
         * @summary Delete an employee\'s home address
         * @param {EmployeeAddressesApiDeleteEmployeeHomeAddressRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async deleteEmployeeHomeAddress(requestParameters: EmployeeAddressesApiDeleteEmployeeHomeAddressRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteEmployeeHomeAddress(requestParameters.homeAddressUuid, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Used for deleting an employee\'s work address.  Cannot delete the employee\'s active work address.  scope: `employees:manage`
         * @summary Delete an employee\'s work address
         * @param {EmployeeAddressesApiDeleteEmployeeWorkAddressRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async deleteEmployeeWorkAddress(requestParameters: EmployeeAddressesApiDeleteEmployeeWorkAddressRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteEmployeeWorkAddress(requestParameters.workAddressUuid, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * The work address of an employee is used for payroll tax purposes.  scope: `employees:read`
         * @summary Get an employee work address
         * @param {EmployeeAddressesApiGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async get(requestParameters: EmployeeAddressesApiGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EmployeeWorkAddress>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.get(requestParameters.workAddressUuid, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * The home address of an employee is used to determine certain tax information about them. Addresses are geocoded on create and update to ensure validity.  Supports home address effective dating and courtesy withholding.  scope: `employees:read`
         ...
         * Returns a list of an employee\'s work addresses. Each address includes its effective date and a boolean signifying if it is the currently active work address.  scope: `employees:read`
         * @summary Get an employee\'s work addresses
         * @param {EmployeeAddressesApiGetWorkAddressesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getWorkAddresses(requestParameters: EmployeeAddressesApiGetWorkAddressesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<EmployeeWorkAddress>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getWorkAddresses(requestParameters.employeeId, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * The home address of an employee is used to determine certain tax information about them. Addresses are geocoded on create and update to ensure validity.  Supports home address effective dating and courtesy withholding.  scope: `employees:write`
...
export const EmployeeAddressesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteEmployeeHomeAddress(requestParameters: EmployeeAddressesApiDeleteEmployeeHomeAddressRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteEmployeeHomeAddress(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Used for deleting an employee\'s work address.  Cannot delete the employee\'s active work address.  scope: `employees:manage`
         * @summary Delete an employee\'s work address
         ...
         * @throws {RequiredError}
         */
        deleteEmployeeWorkAddress(requestParameters: EmployeeAddressesApiDeleteEmployeeWorkAddressRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.deleteEmployeeWorkAddress(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * The work address of an employee is used for payroll tax purposes.  scope: `employees:read`
         * @summary Get an employee work address
         ...
         * @throws {RequiredError}
         */
        get(requestParameters: EmployeeAddressesApiGetRequest, options?: AxiosRequestConfig): AxiosPromise<EmployeeWorkAddress> {
         ...
         * @throws {RequiredError}
         */
        getWorkAddresses(requestParameters: EmployeeAddressesApiGetWorkAddressesRequest, options?: AxiosRequestConfig): AxiosPromise<Array<EmployeeWorkAddress>> {
...
/**
 * Request parameters for deleteEmployeeHomeAddress operation in EmployeeAddressesApi.
 * @export
 * @interface EmployeeAddressesApiDeleteEmployeeHomeAddressRequest
 */
export type EmployeeAddressesApiDeleteEmployeeHomeAddressRequest = {
    
    /**
    * The UUID of the home address
    * @type {string}
    * @memberof EmployeeAddressesApiDeleteEmployeeHomeAddress
    */
...
/**
 * Request parameters for deleteEmployeeWorkAddress operation in EmployeeAddressesApi.
 * @export
 * @interface EmployeeAddressesApiDeleteEmployeeWorkAddressRequest
 */
export type EmployeeAddressesApiDeleteEmployeeWorkAddressRequest = {
    
    /**
    * The UUID of the work address
    * @type {string}
    * @memberof EmployeeAddressesApiDeleteEmployeeWorkAddress
    */
...
/**
 * Request parameters for get operation in EmployeeAddressesApi.
 * @export
 * @interface EmployeeAddressesApiGetRequest
 */
export type EmployeeAddressesApiGetRequest = {
    
    /**
    * The UUID of the work address
    * @type {string}
    * @memberof EmployeeAddressesApiGet
    */
    readonly workAddressUuid: string
...
/**
 * Request parameters for getWorkAddresses operation in EmployeeAddressesApi.
 * @export
 * @interface EmployeeAddressesApiGetWorkAddressesRequest
 */
export type EmployeeAddressesApiGetWorkAddressesRequest = {
    
    /**
    * The UUID of the employee
    * @type {string}
    * @memberof EmployeeAddressesApiGetWorkAddresses
    */
    readonly employeeId: string
...
export class EmployeeAddressesApiGenerated extends BaseAPI {
     ...
     * @memberof EmployeeAddressesApiGenerated
     */
    public deleteEmployeeHomeAddress(requestParameters: EmployeeAddressesApiDeleteEmployeeHomeAddressRequest, options?: AxiosRequestConfig) {
        return EmployeeAddressesApiFp(this.configuration).deleteEmployeeHomeAddress(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EmployeeAddressesApiGenerated
     */
    public deleteEmployeeWorkAddress(requestParameters: EmployeeAddressesApiDeleteEmployeeWorkAddressRequest, options?: AxiosRequestConfig) {
        return EmployeeAddressesApiFp(this.configuration).deleteEmployeeWorkAddress(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EmployeeAddressesApiGenerated
     */
    public get(requestParameters: EmployeeAddressesApiGetRequest, options?: AxiosRequestConfig) {
        return EmployeeAddressesApiFp(this.configuration).get(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EmployeeAddressesApiGenerated
     */
    public getWorkAddresses(requestParameters: EmployeeAddressesApiGetWorkAddressesRequest, options?: AxiosRequestConfig) {
        return EmployeeAddressesApiFp(this.configuration).getWorkAddresses(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
