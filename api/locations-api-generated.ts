...
export const LocationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getDetails: async (locationId: string, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'locationId' is not null or undefined
            assertParamExists('getDetails', 'locationId', locationId)
         ...
         * @throws {RequiredError}
         */
        listCompanyLocations: async (companyId: string, page?: number, per?: number, xGustoApiVersion?: '2024-03-01', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
            assertParamExists('listCompanyLocations', 'companyId', companyId)
            const localVarPath = `/v1/companies/{company_id}/locations`
                .replace(`{${"company_id"}}`, encodeURIComponent(String(companyId !== undefined ? companyId : `-company_id-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const LocationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Get a location.  scope: `companies:read`
         * @summary Get a location
         * @param {LocationsApiGetDetailsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getDetails(requestParameters: LocationsApiGetDetailsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Location>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getDetails(requestParameters.locationId, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get minimum wages for a location  scope: `companies:read`
         ...
         * Company locations represent all addresses associated with a company. These can be filing addresses, mailing addresses, and/or work locations; one address may serve multiple, or all, purposes.  Since all company locations are subsets of locations, retrieving or updating an individual record should be done via the locations endpoints.  scope: `companies:read`
         * @summary Get company locations
         * @param {LocationsApiListCompanyLocationsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listCompanyLocations(requestParameters: LocationsApiListCompanyLocationsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Location>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listCompanyLocations(requestParameters.companyId, requestParameters.page, requestParameters.per, requestParameters.xGustoApiVersion, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Update a location.  scope: `companies.write`
...
export const LocationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getDetails(requestParameters: LocationsApiGetDetailsRequest, options?: AxiosRequestConfig): AxiosPromise<Location> {
         ...
         * @throws {RequiredError}
         */
        listCompanyLocations(requestParameters: LocationsApiListCompanyLocationsRequest, options?: AxiosRequestConfig): AxiosPromise<Array<Location>> {
            return localVarFp.listCompanyLocations(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Update a location.  scope: `companies.write`
         * @summary Update a location
...
/**
 * Request parameters for getDetails operation in LocationsApi.
 * @export
 * @interface LocationsApiGetDetailsRequest
 */
export type LocationsApiGetDetailsRequest = {
    
    /**
    * The UUID of the location
    * @type {string}
    * @memberof LocationsApiGetDetails
    */
...
/**
 * Request parameters for listCompanyLocations operation in LocationsApi.
 * @export
 * @interface LocationsApiListCompanyLocationsRequest
 */
export type LocationsApiListCompanyLocationsRequest = {
    
    /**
    * The UUID of the company
    * @type {string}
    * @memberof LocationsApiListCompanyLocations
    */
    readonly companyId: string
...
export class LocationsApiGenerated extends BaseAPI {
     ...
     * @memberof LocationsApiGenerated
     */
    public getDetails(requestParameters: LocationsApiGetDetailsRequest, options?: AxiosRequestConfig) {
        return LocationsApiFp(this.configuration).getDetails(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LocationsApiGenerated
     */
    public listCompanyLocations(requestParameters: LocationsApiListCompanyLocationsRequest, options?: AxiosRequestConfig) {
        return LocationsApiFp(this.configuration).listCompanyLocations(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
