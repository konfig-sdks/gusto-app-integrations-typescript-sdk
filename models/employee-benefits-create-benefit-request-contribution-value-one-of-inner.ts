 ...
 * @export
 * @interface EmployeeBenefitsCreateBenefitRequestContributionValueOneOfInner
 */
export interface EmployeeBenefitsCreateBenefitRequestContributionValueOneOfInner {
    /**
     * The percentage of employee deduction within this tier the company contribution will match.
     * @type {string}
     * @memberof EmployeeBenefitsCreateBenefitRequestContributionValueOneOfInner
     */
    'rate'?: string;
    /**
