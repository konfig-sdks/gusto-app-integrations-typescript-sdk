...
/**
 * This class provides a wrapper for network errors when making requests to Gusto API
 */
export class GustoAppIntegrationsError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "GustoAppIntegrationsError";
